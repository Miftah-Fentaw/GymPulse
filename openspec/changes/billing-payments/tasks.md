...
- [ ] 1.1 Migration for invoices, line items, payments, receipt numbers; RLS on — verify: migrate up
...
- [ ] 3.1 Member + plan + invoice + cash payment + receipt + overdue list — verify: `go test` against Postgres
