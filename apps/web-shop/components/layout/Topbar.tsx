    ...
    <header className="h-14 bg-white border-b border-surface-border flex items-center px-6 gap-4 sticky top-0 z-30">
      ...
      <div ref={profileRef} className="relative">
        ...
        >
          ...
          <span className="hidden sm:block text-xs font-semibold text-gray-700 max-w-[130px] truncate">
            {roleDisplay}
          </span>
        ...
        {profileOpen && (
          <div className="absolute right-0 mt-2 w-52 bg-white rounded-xl shadow-lift border border-surface-border overflow-hidden z-50">
            ...
            <Link
              ...
              className="flex items-center gap-2.5 px-4 py-2.5 text-xs font-medium text-gray-700 hover:bg-surface"
            >
            ...
            <div className="border-t border-surface-border">
              <button
                ...
                className="w-full flex items-center gap-2.5 px-4 py-2.5 text-xs font-medium text-danger hover:bg-danger-light text-left"
              >
