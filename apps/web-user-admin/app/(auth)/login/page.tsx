      ...
      <div className="w-full max-w-md">
        ...
        <div className="flex items-center justify-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-xs text-ink-ghost font-medium">Backend-Driven Admin Portal</p>
          </div>
        </div>
        ...
        <div className="card shadow-xl border border-gray-100 p-8 rounded-2xl bg-white">
          ...
          <p className="text-sm text-ink-muted mb-6">
            Enter your credentials. All authentication requests are processed via the Go Backend service.
          </p>
        ...
        <p className="text-center text-xs text-ink-ghost mt-6 font-medium">
          GymPulse Monorepo · Strict Go Backend Gateway Enabled
        </p>
      </div>
    </div>
  );
